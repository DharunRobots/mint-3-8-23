...
public class DataDownload {
	...
	By occupation = By.xpath("//ion-checkbox[@formcontrolname=\"occupation_id\"]");
	By buy_reason = By.xpath("//ion-checkbox[@formcontrolname=\"buy_reason_id\"]");
	...
	/*
	 * public void () { element = driver.findElement(); clickElement(element); }
	 * public void () { element = driver.findElement(); clickElement(element); }
	 */
